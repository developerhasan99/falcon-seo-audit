  ...
  return (
    <>
      ...
      <Card className="mb-4">
        ...
        <ErrorItem title="Pages have duplicate meta description" count={11} />
      ...
      <Card className="mb-4">
        ...
        <WarningItem title="Pages have duplicate meta description" count={11} />
        <WarningItem title="Pages have to short meta description" count={11} />
        <WarningItem title="Pages have to short meta description" count={11} />
      </Card>
    </>
  );
