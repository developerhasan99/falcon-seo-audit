    ...
    return (
        <Card className="mb-4">
            ...
            <div className="grid grid-cols-4 gap-8 px-6 py-2 border-t border-solid">
                <InsightProgressBar title="1 high issue" percentage="30%" className="bg-red-600" Icon={Triangle} iconClass="text-red-600" />
                <InsightProgressBar title="2 medium issue" percentage="30%" className="bg-orange-500" Icon={Square} iconClass="text-orange-500" />
                <InsightProgressBar title="3 low issue" percentage="30%" className="bg-gray-600" Icon={Circle} iconClass="text-gray-600" />
                <InsightProgressBar title="15 tests passed" percentage="30%" className="bg-green-600" Icon={Check} iconClass="text-green-600" />
            </div>
            <div className="grid grid-cols-4 gap-8 px-6 py-2 border-t border-solid">
    ...
    return (
        <div className="py-2">
            ...
            <div className="flex overflow-hidden bg-gray-200 rounded text-xs leading-[0] h-[5px] w-100">
                <div className={twMerge("rounded transition-all duration-300", className)} role="progressbar" style={{ width: percentage }}></div>
            </div>
        </div>
    )
}
