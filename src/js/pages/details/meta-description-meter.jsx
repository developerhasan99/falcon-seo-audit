    ...
    switch (status) {
      ...
      case "has-issues":
        return {
          ...
          message:
            "The meta description has some issues that could be improved.",
          icon: Square,
          issues,
        };
      case "not-available":
        return {
          ...
          barColor: "bg-red-500",
          message:
            "No meta description available. Please add a description to improve SEO.",
          icon: X,
  ...
  return (
    <DetailsEntryWrap>
      <div className="flex gap-4 items-center">
        ...
        />
        <div className="text-base font-semibold">Meta Description</div>
      </div>
