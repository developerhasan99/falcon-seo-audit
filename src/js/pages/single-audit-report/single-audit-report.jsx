        ...
        {isLoading ? (
          ...
          >
            {audit.length > 0 ? (
              <>
                <Card>
                  <div className="px-5 py-2 grid grid-cols-8 gap-2 rounded-t">
                    <div className="font-bold text-base">S/L</div>
                    <div className="font-bold text-base col-span-2">URL</div>
                  ...
                  {audit.map((item, index) => {
                    ...
                    return (
                      <div className="px-5 py-3 grid grid-cols-8 gap-2 items-center border-t border-solid border-gray-200">
