...
function falcon_seo_audit_activate_plugin()
{
    ...
    $sql2 = "CREATE TABLE IF NOT EXISTS $single_content_report_table (
        ...
        compressed_size int(20) NOT NULL,
        uncompressed_size int(20) NOT NULL,
        encoding varchar(20) NOT NULL,
        word_count int(20) NOT NULL,
        paragraph_count int(20) NOT NULL,
        average_words_per_paragraph int(20) NOT NULL,
        sentence_count int(20) NOT NULL,
        average_words_per_sentence int(20) NOT NULL,
        readability_score int(20) NOT NULL,
        node_count int(20) NOT NULL,
